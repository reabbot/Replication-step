#Rebecca Abbott, script to replicate the work of Jay Ulfelder "CPG STATISTICAL RISK ASSESSMENT" available on github
...
write.csv(df,"outdata.csv",row.names=FALSE)
####################################
# Model Formulae
####################################
...
write.csv(insamp, file = "c:\\Users\\Bobabtar\\Desktop\\Dissertation_data\\outdata\\insamp.csv", row.names = FALSE)
...
write.csv(newcast, "c:\\Users\\Bobabtar\\Desktop\\Dissertation_data\\outdata\\latest.csv", row.names = FALSE)
...
mapname <- paste("c:\\Users\\Bobabtar\\Desktop\\Dissertation_data\\figs\\heatmap", datestring, "png", sep = ".")
...
date <- as.Date(Sys.Date())
datestring <- paste(substr(date,1,4), substr(date,6,7), substr(date,9,10), sep="")
mapname <- paste("c:\\Users\\Bobabtar\\Desktop\\Dissertation_data\\figs\\scaledmap", datestring, "png", sep = ".")
...
date <- as.Date(Sys.Date())
datestring <- paste(substr(date,1,4), substr(date,6,7), substr(date,9,10), sep="")
dotname <- paste("c:\\Users\\Bobabtar\\Desktop\\Dissertation_data\\figs\\dotplot", datestring, "png", sep = ".")
